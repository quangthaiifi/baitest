...
public class CategoriesController {
	...
	public Categories get(@PathVariable("categoryId") Integer categoryId) {
		final Categories categories = categoriesService.getOne(categoryId);
	...
	private String resolveIdForLogger(Integer categoryId) {
