...
public class LibrariesController {
	...
	public List<Libraries> findAll() {
		List<Libraries> list = librariesService.findAll();
		return list;
	}


	@GetMapping("{libraryId}")
	public Libraries get(@PathVariable("libraryId") Integer libraryId) {
		final Libraries libraries = librariesService.getOne(libraryId);
	...
	public Boolean update(@RequestBody Libraries libraries) {
		return librariesService.update(libraries);
	}

	@DeleteMapping("{libraryId}")
	public void delete(@PathVariable("libraryId") Integer libraryId) {
	...
	private String resolveIdForLogger(Integer libraryId) {
